// CommonJS copy of root solver.js for server-side use.
// Keep math logic in sync with the browser version at /solver.js
...
function getRandomSolvablePuzzle() {
  let numbers;
  do {
...
module.exports = { isSolvable, getSolution, getRandomSolvablePuzzle };
